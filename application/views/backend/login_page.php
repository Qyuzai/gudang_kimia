      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="<?php echo site_url('backendhome/signin'); ?>" method="post" enctype="multipart/form-data">
              <h1>Login Form</h1>
              <div>
              ...
              <div>
                <!-- <a class="btn btn-default submit" href="<?php echo base_url('backendhome/admin'); ?>">Log in</a> -->
                <button class="btn btn-default submit">Log in</button>
                <a class="reset_pass" href="<?php echo base_url('frontendhome/home'); ?>">Back To Site</a>
              </div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-flask"></i> Monitoring LAB</h1>
        ...
        <div id="register" class="animate form registration_form">
          <section class="login_content">
            <form>
              ...
              <div>
                <a class="btn btn-default submit" href="<?php echo base_url('backendhome/login'); ?>">Submit</a>
              </div>
