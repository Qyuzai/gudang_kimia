...
?>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9 ">
<?php
if (empty($statuskimia)) {
    echo "";
}else{
    foreach ($statuskimia as $val) {
?>
                        <div class="radio">
                          <label>
                            <input type="radio" class="flat iCheck2" name="status_item" id="1" value="<?php echo $val['jenis_id'];?>"> <?php echo $val['nama_jenis'];?>
                          </label>
                        </div>
<?php 
    }//endFOREACH
